...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 21 2018 г., 22:00
...
(1, 'Assets/Lyrics/lyrics.txt', '1 : 24', 'musiccc', NULL, 'ggg', 'Assets/Music/Boris_Vian_-_La_complainte_du_progrÃ¨s_1956[www.MP3Fiber.com].mp3', 1),
(2, 'Assets/Lyrics/l.txt', 't : t', 't', NULL, 't', 'Assets/Music/Notre Dame de Paris Le Temps des CathÃ©drales.mp3', 1),
(4, '', 'v : v', 'v', NULL, 'v', 'Assets/Music/marsh_stalinskoj_aviatsii_vsyo_vyshe_i_vyshe_i_vyshe_1931_g (rappro.net).mp3', 2);
