...
if($resultatfetch[0][0] == null){
    echo "La recherche n'a affiché aucun résultat, vous avez peut être mal tapé ou alors il n'y a pas de musique assimilé à cette catégorie";
}
